...
public class TransactionConsumer {
     ...
     * 消费者组
     */
    public static final String CONSUMER_GROUP = "transaction_consumer";
    /**
     * 通过构造函数 实例化对象
     */
    public TransactionConsumer() throws MQClientException {
        ...
        //订阅主题和 标签（ * 代表所有标签)下信息
        consumer.subscribe(MqConfig.TOPIC_TRANS, "*");
        ...
        consumer.start();
        System.out.println("事物消息消费者 启动成功=======");
    }
}
